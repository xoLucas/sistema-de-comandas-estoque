...
Informação de custo, margem de lucro, preço de venda, fornecedores e histórico em cada item do estoque.
Funcionalidade de "Adicionar Carregamento" para entrada rápida de lotes com múltiplos itens.
2.4. Módulo de Promoções
Possibilidade de criar promoções com datas para início e término.
Ativar ou desativar promoções.
2.5. Módulo de Funcionários
Cadastro de funcionários.
Acompanhamento de histórico de trabalho.
Registro de diárias.
2.6. Módulo de Fornecedores
Cadastro de fornecedores.
Nome, contato, produtos, ativo/inativo.
...
Cálculo automático de faturamentos e lucros levando em conta saídas, entradas, taxas, diárias e comissões.
Opção de fechamento do caixa com geração automática de relatório do dia.
Dashboard interativo consolidando dados mensais, semanais e anuais de entradas e saídas do caixa.
2.8. Módulo de Produção
...
3.1. Arquitetura Principal (On-Premise / Rede Local)
A aplicação não dependerá de hospedagem em nuvem, operando 100% dentro da infraestrutura física da distribuidora.
...
Banco de Dados (PostgreSQL): Rodando localmente para armazenamento de estoque, histórico financeir o, transações e usuários de forma segura e rápida.
4. Stack Proposta
...
Custos Fixos de Hardware (Cliente):
2x Impressoras térmicas Ethernet - 240 reais/un.
Roteador com no mínimo 3 portas Lan - 170 reais/un.
Computador com, no mínimo, i3 de 6a geração + 8gb de ram + SSD + porta Lan - 1800 reais em média (a versão all in one).
Cerca de 45m de cabo de rede Cat6. 3x15m - 25 reais/un.
